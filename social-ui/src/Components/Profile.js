...
import { getProfileInfoUser, profileUpdate, updateProfileDp, updateProfileCover } from '../Redux/actions/userAction';
import { useDispatch, useSelector } from 'react-redux';
import PublicPosts from '../Screens/UserPosts';
import { PROFILE_COVER_UPDATE_RESET, PROFILE_DP_UPDATE_RESET, PROFILE_FETCH_USER_RESET, PROFILE_UPDATE_RESET } from '../Redux/ActionTypes';
...
const Profile = ({ username }) => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        if (successProfileUpdate || dpupdateSuccess || coverupdateSuccess) {
    ...
    }, [dispatch, successProfileUpdate, dpupdateSuccess, coverupdateSuccess]);
    ...
    return userInfoLoading ? (
        ...
        <Alert message={userInfoError} type="error" />
    ) : (
        user && (
                    ...
                    <Col span="24">
                        ...
                        <Row>
                            <Col span="24">
                                ...
                                {errorProfileUpdate && (
                                    <Alert message={errorProfileUpdate} type="error" showIcon />
                                )}
                            </Col>
                        </Row>
                        <Row>
